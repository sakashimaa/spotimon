...
## Quick wins
- [ ] Update cheatsheet - missing playlist keybinds (t, c, :, d)
- [ ] Context-aware top bar - shows "Track library" even in playlists/queue view. Switch label based on view_mode (e.g. "Playlists", "Queue", "chill (5 tracks)")
